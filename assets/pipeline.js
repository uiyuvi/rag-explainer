...
function renderPipeline(currentId, containerId='pipeline'){
  ...
  el.innerHTML = `
    <div class="pipeline-wrap">
      ...
      ${desc}
      <div style="margin-top:6px;font-size:11px;color:#737373">Tap a step to jump — no numbers to memorise. <a href="${homeBase}resources.html" style="font-weight:700">Resources</a> for links. • <a href="${base}06_e2e_rag.html" style="font-weight:700">End-to-end</a></div>
    </div>
  `;
}
